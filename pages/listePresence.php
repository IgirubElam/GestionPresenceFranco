			...
			<table class="table table-striped table-bordered">
				...
				<tbody>
					<tr>
						...
						<?php while($r_presences=$resultat_presences->fetch()){ ?>
							<tr>
								<td>
									<center><?php echo $r_presences['Nom_type_activite'] ?></center>
									<center><?php echo "Appel du ".date("d/m/Y",strtotime($r_presences['Date'])) ?></center>
								</td>

								<td><?php echo $r_presences['Nom'] ?></td>
								<td><?php echo $r_presences['Prenom'] ?></td>
							</tr>
						<?php } ?>
					</tr>
				</tbody>
